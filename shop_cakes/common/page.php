...
class page
{
	        ...
	        <nav class="navbar navbar-light navbar-expand-lg">
		        <div class="container-fluid">
				    <a class="navbar-brand">
					    <img src="label_l.jpg" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
					        <span class="navbar-brand mb-0 h1">Msweety Rabbits</span>	
				    </a>	
    ...
    {
        print ('<div class="row">');
        print ('<div class="col-12"><p style="background-color: #fdf5e6; padding-top:30px; padding-bottom:30px; padding-right:30px; text-align:right">© Екатерина Кормушкина, 2023.</p></div>');
        print ('</div>');
    }
